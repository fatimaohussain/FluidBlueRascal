...
public class HTTPStreamer implements HTTPStreamerConstants{
	...
	public HTTPStreamer(File file, long id){
            ...
            logger.info("Entering HTTPStreamer for file :" + file + " with id " + id);
            
            long time = System.currentTimeMillis();

            URLConnection urlConn = getURLConnection();
            long elapsedTime1 = System.currentTimeMillis()- time;
            logger.info("URL connection Time  "  + elapsedTime1  + " " + file.toString());
		...
		writeData(urlConn, file, id);
            ...
            logger.info("Actual Data writting time  "  + elapsedTime2 + " " + file.toString());
		...
		String out = readResponse(urlConn); // letting is go nowhere for now
                ...
                logger.info("Finished reading response  "  + elapsedTime2 + " " + file.toString());
	}
	...
	private void writeData(URLConnection urlConn, File file, long id){
		try {
			...
			//out.writeField("MAX_FILE_SIZE", "40000000");
